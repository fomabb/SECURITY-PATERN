package com.iase24.crazy_task_tracker_api.facade;
...
public class UserFacade {
    ...
    public GetUserResponse getUserById(UUID uuid) {
        ...
        return new GetUserResponse(userId.getId(), userId.getFirstName(), userId.getUsername(), userId.getPassword(), userId.getRole().toString()
//                , userId.getDateCreateUser()
        );
    }
